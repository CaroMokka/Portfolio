      ...
      <div className="wrapper-aboutme">
        ...
        <div className="about-description">
          <p className="about-p">
            ...
            nuevos mundos. Si bien mis proyectos están relacionados al desarrollo
            web, este recorrido me ha permitido conocer y trabajar con una
            diversidad de personas, entre ellas diseñador@s. Aquí es donde me
            encuentro ahora, con un encanto por el UX/UI. Actualmente me
            encuentro becada y cursando el Programa de Certificación UX de
            Google.
          </p>
        </div>
      </div>
